...
public class PatientsData {
    ...
    //All the data members of the patients data
    private Integer id;
    ...
    //Parameterized Constructor of the patients data
    ...
    //Getter method of the patients data to get methods
