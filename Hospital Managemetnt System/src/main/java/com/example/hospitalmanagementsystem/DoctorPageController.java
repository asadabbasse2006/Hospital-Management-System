...
public class DoctorPageController implements Initializable {
    ...
    @FXML private TextField login_doctorID;
    ...
    @FXML private TextField register_doctorID;
            ...
            try {
                ...
                if (result.next()) {
                    ...
                    if (result.next()) {
                        ...
                        Parent root = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("DoctorMainForm.fxml")));
