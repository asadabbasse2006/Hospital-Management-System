...
public class EditDoctorFormController implements Initializable {
    ...
    //All the components required to edit the doctor form
    @FXML private TextField editDoctor_doctorID;
    @FXML private TextField editDoctor_fullName;
    @FXML private TextField editDoctor_email;
    @FXML private TextField editDoctor_password;
    @FXML private ComboBox<String> editDoctor_specialized;
    @FXML private ComboBox<String> editDoctor_gender;
    @FXML private TextField editDoctor_mobileNumber;
    @FXML private ImageView editDoctor_imageView;
    @FXML private Button editDoctor_importBtn;
    @FXML private TextArea editDoctor_address;
    @FXML private ComboBox<String> editDoctor_status;
    @FXML private Button editDoctor_updateBtn;
    @FXML private Button editDoctor_cancelBtn;

    //Alert message object creation
    private final AlertMessage alert = new AlertMessage();

    //Image required to update the doctor information
    private Image image;
    ...
    //Method to import the image for the profile purposes
    ...
    //Method to set the fields of the doctor
    ...
    //Method to store the specialization of the doctor
    ...
    //Method to store the gender of the doctor
    ...
    //Method to store the status of the doctor
    ...
    //Method to display the following methods on the initialization of the program
    @Override
